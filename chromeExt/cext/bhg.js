...
function accio_init() {
  ...
  var magnify_box = function(options) {
    if (mdp.getCurrentBreakPoint() == "smallOnly") {
      return ''
    }
  ...
  var allProductsHtml = function() {
    ...
    $(".relatedContent").before(heading_row[mdp.getCurrentBreakPoint()] + '<div id="all_products_html" style="width: 100%;" class="hide"></div><div style="width: 100%; margin-top: 10px; text-align:center;"><a href="#" style="font-size: 14px; color: black; font-weight: 700;">SHOP ALL PRODUCTS</a></div>');
      ...
      res.croppings.forEach(function(cropping, c_index) {
        if (cropping.products && cropping.products.length > 0) {
          ...
          product_options = makeProductOptions({
            ...
            width: mdp.getCurrentBreakPoint() == 'smallOnly' ? 160 : 200,
            height: mdp.getCurrentBreakPoint() == 'smallOnly' ? 240 : 300,
            index: index + '_' + c_index,
            c_product: c_product
          });
