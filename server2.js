...
// var CCC = require('../routes/server').ccc;
// var ccc = new CCC();


var sendErrorSMStoAdmins=function(err,callback){
    var c= new ccc();
    //     c.sendSms(err,'0123456789',function(e,doc){
    // console.log(e)
    //         console.log(doc)
    //     });
    //     c.sendSms(err,'0123456789',function(e,doc){
...
// sendErrorSMStoAdmins('test error message',function(doc){
//     console.log("dona")
//     console.log(doc);
// })
...
var sendErrorMailtoAdmins=function(title,message,body,callback){
    ...
    console.log(title + " "+ message)
     mailer.sendMails([""], title+" Error Message from UMS " + new Date(),body + "<br>"+message  , function(err, info) {
        if (err) {
...
Srv.prototype.sendErrorMailtoAdmins=function(title,message,body,callback){
    ...
    sendErrorMailtoAdmins(title,message,body ,function(err,info){                
        sendErrorSMStoAdmins(err,function(doc){
                            console.log("dona")
                            console.log(doc);
                        })
         callback(err,info)   
...
var _connection = "";
var pg = require('pg');
var conString = "postgres://postgres:postgres@hostname:5432/database";
var PGSql = function() {};
    ...
    if (!_connection) {
        ...
        client.connect(function(err, connection) {
            if (err) {
                ...
                console.log("postgres is connection")
...
// this will take query as input
// this method will first connect pgsql then is execute the query
PGSql.prototype.execute = function(query, value, callback) {
